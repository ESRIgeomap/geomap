...
export default function getTotalFeatureLayerItem(dataObj) {
  ...
  const requestUrl = "http://esrichina3d.arcgisonline.cn/portal/sharing/search?f=json&" +
    ...
    "q=owner:" + dataObj.owner + " (type:('Feature Collection' OR 'Feature Service' OR 'Stream Service' OR 'WFS') -typekeywords:'Table')";
  return jQuery.ajax({
    type: 'GET',
    url: requestUrl,
