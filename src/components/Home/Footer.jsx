    ...
    <footer id="footer" className="dark">
        ...
        <Row>
          ...
          <Col lg={6} sm={24} xs={24}>
            <div className="footer-center">
              ...
              <div>
                <a target="_blank" rel="noopener" href="http://ant.design/">ArcGIS Geoplat</a>
                <span> - </span>
                <span>时空大数据共享服务平台</span>
              </div>
              <div>
                <a target="_blank" rel="noopener" href="https://antv.alipay.com/">ArcGIS Geoplat Monitor</a>
                <span> - </span>
                <span>蚂蚁数据可视化方案</span>
              </div>
              <div>
      ...
      <Row className="bottom-bar">
        ...
        <Col lg={18} sm={24}>
          ...
          <span style={{ marginRight: 12 }}>ICP 证京 A2-2-100257</span>
          <span style={{ marginRight: 12 }}>Copyright © 平台实施部 Geomap开发小组</span>
        </Col>
      </Row>
    </footer>
  );
